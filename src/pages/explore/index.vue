<template>
  <div class="page bg-surface">
    <t-tabs v-model="currentTab" :list="tabList" bottomLineMode="auto" :spaceEvenly="false" :split="false" />
...
const suggestions = ['沉浸式数码开箱', '泡泡玛特盲盒', '七夕约会穿搭指南', 'RUNTOX 跑出无限可能'];
